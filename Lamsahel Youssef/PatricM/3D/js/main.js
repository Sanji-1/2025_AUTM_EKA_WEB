...
let myRoom = [
    ...
    [0, 200, 0, 90, 0, 0, 3000, 3000, "brown", 1, "url('textures/floor_01.jpg')"],
    
    
    [0, 0, -1500, 0, 0, 0, 3000, 600, "gray", 1, "url('textures/sandy_wall.jpg')"],
    
    
    [0, 0, 1500, 0, 180, 0, 3000, 600, "lightblue", 1, "url('textures/brick.jpg')"],
    
    
    [-1500, 0, 0, 0, 90, 0, 3000, 600, "lightgreen", 1, "url('textures/brick2.jpg')"],
    
    
    [1500, 0, 0, 0, -90, 0, 3000, 600, "lightyellow", 1, "url('textures/brick3.jpg')"],
    
   
    [0, -300, 0, -90, 0, 0, 3000, 3000, "white", 0.9, "url('textures/brick4.jpg')"],
];
